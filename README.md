...
**Комментарий к проекту:** одна из первых работ в ВУЗе, имеет большие проблемы с архитектурой приложения, но делалась с наибольшей возможной на тот момент самоотдачей, кажется, это 1-ый курс, может, 2-ой.
