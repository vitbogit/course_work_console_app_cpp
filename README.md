# 2022 БД для автобусной станции (RU)
...
**Запуск:** для работы с проектом и компиляции удобнее всего будет открыть файл проекта Visual Studio, который представлен в корневой папке - bus_bd.sln
